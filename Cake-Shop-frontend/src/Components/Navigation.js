...
const Navigation = (props) => {
  ...
  return (
    <div>
      <nav className="navbar navbar-expand-lg navbar-dark bg-danger myNav">
        <div className="container-fluid">
          <Link className="navbar-brand  text-light" to="/"><img src={logo} /><strong><i>Dream Cake Wonderland</i></strong></Link>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li className="nav-item dropdown">
                  <a className="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Cakeshop</a>
                  <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                    <li>
                      <Link className="dropdown-item" to="/employees"> View Cakeshop and Delivery Persons</Link>
                    </li>
                    <li>
                      <Link className="dropdown-item" to="/add-employee">Add Cakeshop</Link>
                    </li>
                    <li>
                      <Link className="dropdown-item" to="/delete-employee">Remove Cakeshop</Link>
                    </li>
                  </ul>
                </li>
                <li className="nav-item dropdown">
              ...
              {   
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                            <Link className="nav-link" to="/customer-customizecake"> Customize Cake </Link>
                        </li>
                 </ul>
                 <div className="d-flex">
