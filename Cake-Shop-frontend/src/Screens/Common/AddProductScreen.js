                ...
                <div className="row">
                    ...
                    <div className="col-md-4 Block">                    
                        <div className="mb-3 productHolder text-center">
                            ...
                            <img src={imageFile} className="img-thumbnail img-responsive img-fluid"  alt=""/>
                        </div>
                        ...
                        <div className="row">
                            <div className="col-md-7">
                                ...
                                <div className="mb-3">
                                    ...
                                    <input onChange={(e)=> setQuantity(e.target.value)} type="number" className="NextBtn" defaultValue={1}/>    
                                </div>
                            </div>
                            <div className="col-md-5">
                                <div className="mb-3">
                                    <label className="form-label">Price: </label>
                                    <input onChange={(e)=> setPrice(e.target.value)} type="number" className="NextBtn" placeholder="price" />
                                </div>                            
                                 <div className="mb-3">
