                                        ...
                                        categoryList && categoryList.map(category => {
                                            return(
                                                <tr>
                                                    ...
                                                    <td><button onClick={() => onEdit(category)} className="btn btn-outline-success bg-success text-light">Save</button></td>
                                                    <td><button onClick={()=> onDelete(category.id)} className="btn btn-outline-danger NextBtn bg-danger text-light">Remove</button></td>
                                                </tr>
                                            ) 
                                        })
                                    }
