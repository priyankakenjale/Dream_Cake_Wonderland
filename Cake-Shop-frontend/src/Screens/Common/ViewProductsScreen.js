                        ...
                        return(
                            <div className="col-md-3 col-sm-6 col-xs-12 myCardElement">
                                <div className="card">
                                    ...
                                    {/* console.log({url_image+`/${detail.product.imageName}`}); */}
                                        
                                        {
                                            detail.product.imageName!==null &&
                                             //<img src={url_image+`/${detail.product.imageName}`} alt={detail.product.imageName} className="img-fluid productImage"/>
                                             <img src={detail.product.imageName} alt={detail.product.imageName} className="img-fluid productImage"/>
                                        ...
                                        <div className="card-text">
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-md-4 Block"><button onClick={() => {onEdit(detail)}} className="btn btn-success">Edit</button></div>
                                                <div className="col-md-4"><button onClick={() => {onDelete(detail.product.id, detail.category)}} className="btn btn-danger">Delete</button></div>
                                            </div>
                                        </div>
