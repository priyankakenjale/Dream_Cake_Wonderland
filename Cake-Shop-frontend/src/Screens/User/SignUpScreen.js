...
const SignUpScreen = (props) => {
    ...
    const onSignUp = () => {
        ...
        if(firstName.length>1 && password.length>1 && email.match("^[a-zA-Z0-9+_.-]+@[a-zA-Z0-9.-]+$") && phone.length>1 && ((role==="CUSTOMER" && !userSignIn.response) || role==="EMPLOYEE" || role==="DELIVERY_PERSON"))
            dispatch(signup(firstName,lastName,email,password,phone,role))
    }
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            ...
                            <div className="mb-3">
                                ...
                                <input required onChange={(e)=>{setPhone(e.target.value)}} type="text" className="form-control"  placeholder="phone"></input>
