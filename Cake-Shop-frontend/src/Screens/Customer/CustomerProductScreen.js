...
import img2 from '../../Images/c5.jpg';
import img3 from '../../Images/c6.jpg';
import img4 from '../../Images/c7.jpg';
        ...
        <div className="Screen">
          ...
          <div className="container">
                ...
                <div class="carousel-inner">
                 <div class="carousel-item active " data-inteval="1000" >
                     <img class="d-block w-100" src={img1} style={{height:"500px"}} alt="First slide"/>
                </div>
               <div class="carousel-item">
                     <img class="d-block w-100" src={img2} style={{height:"500px"}} alt="Second slide"/>
               </div>
               <div class="carousel-item">
                    <img class="d-block w-100" src={img3} style={{height:"500px"}} alt="Third slide"/>
               </div>
               <div class="carousel-item">
                    <img class="d-block w-100" src={img4} style={{height:"500px"}} alt="Third slide"/>
               </div>
            </div>
                                        ...
                                        <div className="col-md-3 col-sm-6 col-xs-12 myCardElement">
                                            <div className="card">
                                                ...
                                                }
                                                {
                                                    ...
                                                    <div className="card-description"> <h6>{product.description}</h6></div>
